...
public class NetManagerUtil {
    ...
    public static String net(String strUrl, Map params, String method) throws IOException {
        ...
        System.out.println("NetManagerUtil.net" + sb.toString());
        rs = sb.toString();
    ...
    public static String urlencode(Map<String, Object> data) {
        ...
        for (Map.Entry i : data.entrySet()
            ...
            //
            try {
                //URLEncoder.encode(i.getValue() + "", "UTF-8")将参数按照utf-8的格式编码
    ...
    public static String post(String url,String data){
        System.out.println("NetManagerUtil.post"+data);
        try {
